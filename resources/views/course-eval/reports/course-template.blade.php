        ...
        <div class="container" id="out-div">
            ...
            <div class="row mt-4 mb-2 border-bottom">
                <div class="col-md-12" id="co-out">
                    <h5 class="mb-0">{{ $helper->results['name'] }} Course Overall Report</h5>
                </div>
            </div>
            <div class="row mb-4">
                <div class="col-md">
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>                                
                                ...
                                <td><p class="text-center">{{ !array_key_exists('lr', $helper->results['overall']['uniCourseHighests']) ? '---' : $helper->results['overall']['uniCourseHighests']['lr'] }}</p></td>
                ...
                <div class="col-md-12">
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>                                
                                <td><p><b>Lab Rating</b></p></td>
                                <td><p class="text-center">{{ array_key_exists('lr', $helper->results['lowest'])  == 0 ? '---' : $helper->results['lowest']['lr'] }}</p></td>
                                <td><p class="text-center">{{ array_key_exists('lr', $helper->results['highest'])  == 0 ? '---' : $helper->results['highest']['lr'] }}</p></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
